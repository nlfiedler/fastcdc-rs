...
//! 2020. It incorporates a simplified hash judgement using the fast Gear hash,
//! sub-minimum chunk cut-point skipping, normalized chunking to produce chunks
//! of a more consistent length, and "rolling two bytes each time". According to
//! the authors, this should be 30-40% faster than the 2016 version while
//! producing the same cut points.
//!
