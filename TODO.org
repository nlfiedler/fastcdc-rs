* Action Items
** DONE commit doc changes
** DONE file bug ~two-byte scan changes scalar cut-point rules~ (#52)
** DONE fix #51: make the masks match the papers
** DONE fix #50: incorrect size_hint value
** DONE fix two-byte scan bug (#52)
