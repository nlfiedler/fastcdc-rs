* Action Items
** TODO commit doc changes
** TODO file bug ~two-byte scan changes scalar cut-point rules~
** TODO fix #51: make the masks match the papers
** TODO fix #50: incorrect size_hint value
** TODO fix two-byte scan bug
